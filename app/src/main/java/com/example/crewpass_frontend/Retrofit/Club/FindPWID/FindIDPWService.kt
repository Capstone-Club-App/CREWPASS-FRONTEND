...
class FindIDPWService {
    ...
    // 아이디 이메일 인증
    private lateinit var findIDEmailClubNameResult: FindIDEmailClubNameResult

    fun setFindIDEmailClubNameResult(findIDEmailClubNameResult: FindIDEmailClubNameResult) {
        this.findIDEmailClubNameResult = findIDEmailClubNameResult
    }
    ...
    fun findIDByEmailClubName(
        ...
        authService.findIDByEmailClubName(
            crewName,
            email
        ).enqueue(object :
            ...
            override fun onResponse(
                ...
                if (response.body() != null) {
                    ...
                    when (resp.statusCode) {
                        200 -> {
                            findIDEmailClubNameResult.findIdEmailClubNameSuccess(resp.statusCode, resp.data)
                        }
                        else -> {
                            findIDEmailClubNameResult.findIdEmailClubNameFailure(resp.statusCode)
                        }
                    }
                } else
    ...
    fun findIDByNumb(
        crewName : String, email: String, certificateNumb : Int, inputCertificateNumb : Int
    ) {
