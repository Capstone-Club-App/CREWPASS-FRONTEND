...
class QuestionService {
    ...
    fun postQuestion(crew_id : Int, recruitment_id : Int,
                        ...
                        question7Limit : Int?)
    {
        ...
        authService.postQuestion(crew_id, recruitment_id, question1, question2, question3, question4, question5, question6, question7,
            question1Limit, question2Limit, question3Limit, question4Limit, question5Limit, question6Limit, question7Limit).enqueue(object :
            Callback<QuestionPostResponse> {
            override fun onResponse(call: Call<QuestionPostResponse>, response: Response<QuestionPostResponse>,) {
